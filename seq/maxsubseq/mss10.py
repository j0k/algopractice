...
# т.е. хочется часть понимания реализации сторонних функций и алгоритмов переложить
# на комп

# какая-то прямо машина понимания. в общем виде это задача очень сложная
# более простая задача это реализовать один или два типа редукции мозга
# для конкретных паттернов и может в терминал expression-styles
# для конкретных стилей программирования
